...
public class Archivos2_Eliminar extends javax.swing.JFrame {

    public Archivos2_Eliminar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archivos2_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
