...
public class Archivos3_Modificar extends javax.swing.JFrame {

    public Archivos3_Modificar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archivos3_Modificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Archivos3_Modificar().setVisible(true);
            }
        });
    }
