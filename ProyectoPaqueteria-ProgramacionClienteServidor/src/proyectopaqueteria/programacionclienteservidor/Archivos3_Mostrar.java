...
public class Archivos3_Mostrar extends javax.swing.JFrame {

    public Archivos3_Mostrar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archivos3_Mostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
